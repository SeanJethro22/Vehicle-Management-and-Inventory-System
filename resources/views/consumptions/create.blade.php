                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-lg"><i class="fa fa-car" aria-hidden="true"></i>&nbsp; Add Fuel Request</h3>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <div class="float-end">
                                    <a href="{{ route('consumptions.index') }}" class="btn btn-primary btn-sm">&larr; Back</a>
                                </div>
                            </div>
