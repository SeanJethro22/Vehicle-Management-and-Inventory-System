                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="td1" class="col-form-label">Time of Departure from Office</label>
                                                        <input type="time" class="form-control @error('td1') is-invalid @enderror" id="td1" name="td1" value="{{ old('td1') }}">
                                                        @if ($errors->has('td1'))
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ta1" class="col-form-label">Time of Arrival at Destination</label>
                                                        <input type="time" class="form-control @error('ta1') is-invalid @enderror" id="ta1" name="ta1" value="{{ old('ta1') }}">
                                                        @if ($errors->has('ta1'))
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="td2" class="col-form-label">Time of Departure from Destination</label>
                                                        <input type="time" class="form-control @error('td2') is-invalid @enderror" id="td2" name="td2" value="{{ old('td2') }}">
                                                        @if ($errors->has('td2'))
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ta2" class="col-form-label">Time of Arrival back to the Office</label>
                                                        <input type="time" class="form-control @error('ta2') is-invalid @enderror" id="ta2" name="ta2" value="{{ old('ta2') }}">
                                                        @if ($errors->has('ta2'))
                                            ...
                                            <div class="form-group row">                            
                                                ...
                                                <div class="col-sm-2 mb-3 mb-sm-0">
                                                    <label for="bal_end" class="col-form-label">Balance End</label>
                                                        <input type="number" class="form-control @error('bal_end') is-invalid @enderror" id="bal_end" name="bal_end" value="{{ old('bal_end') }}" readonly>
