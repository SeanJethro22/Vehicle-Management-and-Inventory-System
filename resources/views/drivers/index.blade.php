                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header mt-3">
                        <h2 class="card-title text-lg"><b>Driver Management</b></h2>
                          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            @can('create-driver')
                            <div class="text-right">
                                <a href="{{ route('drivers.create') }}" class="btn btn-success"><i class="nav-icon fa fa-plus btn-lg"></i></a>
                                <br>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $driver->driverFN }}</td>
                                            <td>{{ $driver->driverMN }}</td>
                                            <td>{{ $driver->driverLN }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('drivers.destroy', $driver->id) }}" method="post">
                                                    ...
                                                    <a href="{{ route('drivers.show', $driver->id) }}" class="btn btn-outline-success btn-sm" 
                                                    data-toggle="modal" 
                                                    data-target="#driverModal{{ $driver->id }}">
                                                    <i class="fa fa-eye"></i></a>

                                                        @can('edit-driver')
                                                            <a href="{{ route('drivers.edit', $driver->id) }}" class="btn btn-outline-primary btn-sm"><i class="fa fa-wrench"></i></a>   
                                                        @endcan
                                                    ...
                                                    <div class="modal fade" id="driverModal{{ $driver->id }}" tabindex="-1" role="dialog" aria-labelledby="driverModalLabel{{ $driver->id }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl"> <div class="modal-content">
                                                        <div class="modal-header">
                                                        <h5 class="modal-title" id="driverModalLabel{{ $driver->id }}"><strong>Driver Management</strong></h5>
                                                                                        ...
                                                                                        <div class="form-group row text-sm">
                                                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                                                <label for="ca_street" class="col-form-label">Street</label>
                                                                                                    <input type="text" class="form-control text-center" 
                                                                                                    value="{{ $driver->ca_street }}" readonly>
                                                                                            </div>

                                                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                                                <label for="ca_purok" class="col-form-label">Purok</label>
                                                                                                    <input type="text" class="form-control text-center" 
                                                                                                    value="{{ $driver->ca_purok }}" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group row text-sm">
                                                                                            <div class="col-sm-10 mb-3 mb-sm-0">
                                                                                                <label for="ca_province" class="col-form-label">Province</label>
                                                                                                    <input type="text" class="form-control text-center" 
                                                                                                    value="{{ $driver->ca_province }}" readonly>
                                                                                            </div>

                                                                                            <div class="col-sm-2 mb-3 mb-sm-0">
                                                                                                <label for="ca_zipcode" class="col-form-label">Zip Code</label>
                                                                                                    <input type="text" class="form-control text-center" 
                                                                                                    value="{{ $driver->ca_zipcode }}" readonly>
                                                                                            </div>
                                                                                        </div>                                            
                                                                                        ...
                                                                                        <div class="form-group row text-sm">
                                                                                            ...
                                                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                                                <label for="division" class="col-form-label">Division</label>
                                                                                                    <input type="text" class="form-control text-center" 
                                                                                                    value="{{ $driver->division }}" readonly>
                                                                                            </div>
                                                                                        </div>                                                
                                                                                    </div><!-- /.row -->
                                                                                </form>
