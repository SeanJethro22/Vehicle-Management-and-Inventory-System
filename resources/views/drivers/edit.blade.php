                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="suffix" class="col-form-label">Suffix</label>
                                                        <select name="suffix" id="gender" class="form-control @error('suffix') is-invalid @enderror" 
                                                            value="{{ $driver->suffix }}">
                                                            <option value="N/A" @selected(old('suffix', $driver->suffix) == 'N/A')>N/A</option>
                                                            <option value="Jr." @selected(old('suffix', $driver->suffix) == 'Jr.')>Jr.</option>
                                                            <option value="Sr." @selected(old('suffix', $driver->suffix) == 'Sr.')>Sr.</option>
                                                            <option value="II" @selected(old('suffix', $driver->suffix) == 'II')>II</option>
                                                            <option value="III" @selected(old('suffix', $driver->suffix) == 'III')>III</option>
                                                            <option value="IV" @selected(old('suffix', $driver->suffix) == 'IV')>IV</option>
                                                            <option value="V" @selected(old('suffix', $driver->suffix) == 'V')>V</option>
                                                            <option value="VI" @selected(old('suffix', $driver->suffix) == 'VI')>VI</option>
                                                            <option value="VII" @selected(old('suffix', $driver->suffix) == 'VII')>VII</option>
                                                            <option value="VIII" @selected(old('suffix', $driver->suffix) == 'VIII')>VIII</option>
                                                            <option value="IX" @selected(old('suffix', $driver->suffix) == 'IX')>IX</option>
                                                            <option value="X" @selected(old('suffix', $driver->suffix) == 'X')>X</option>
                                                        </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row text-sm">
                                                ...
                                                <div class="col-sm-2 mb-3 mb-sm-0">
                                                    <label for="civilStatus" class="col-form-label">Civil Status</label>
                                                        ...
                                                        value="{{ $driver->civilStatus }}">                                                            
                                                            <option value="Single" @selected(old('civilStatus', $driver->civilStatus) == 'Single')">Single</option>
                                                            <option value="Married" @selected(old('civilStatus', $driver->civilStatus) == 'Married')">Married</option>
                                                            <option value="Separated" @selected(old('civilStatus', $driver->civilStatus) == 'Separated')">Separated</option>
                                                            <option value="Divorced" @selected(old('civilStatus', $driver->civilStatus) == 'Divorced')">Divorced</option>
                                                            <option value="Widowed" @selected(old('civilStatus', $driver->civilStatus) == 'Widowed')">Widowed</option>
                                                        </select>
                                                ...
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <label for="status" class="col-form-label">Status</label>
                                                        <select name="status" id="gender" class="form-control @error('status') is-invalid @enderror" 
                                                            value="{{ $driver->status }}">
                                                            <option value="Permanent" @selected(old('status', $driver->status) == 'Permanent')">Permanent</option>
                                                            <option value="Job Order" @selected(old('status', $driver->status) == 'Job Order')">Job Order</option>
                                                            <option value="Contract of Service" @selected(old('status', $driver->status) == 'Contract of Service')">Contract of Service</option>
                                                            <option value="Contractual" @selected(old('status', $driver->status) == 'Contractual')">Contractual</option>
                                                            <option value="Coterminous" @selected(old('status', $driver->status) == 'Coterminous')">Coterminous</option>
                                                        </select>
                                                ...
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <label for="division" class="col-form-label">Division</label>
                                                        <select name="division" id="division" class="form-control @error('division') is-invalid @enderror" 
                                                            ...
                                                            <option value="Administrative Support Services" @selected(old('division', $driver->division) == 'Administrative Support Services')">Administrative Support Services</option>
                                                            <option value="Administration and Training Division" @selected(old('division', $driver->division) == 'Administration and Training Division')">Administration and Training Division</option>
                                                            <option value="Planning and Research Division" @selected(old('division', $driver->division) == 'Planning and Research Division')">Planning and Research Division</option>
                                                            <option value="Operations and Warning Division" @selected(old('division', $driver->division) == 'Operations and Warning Division')">Operations and Warning Division</option>
                                                        </select>
