                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-lg"><i class="fa fa-user" aria-hidden="true"></i>&nbsp; Add New Part</h3>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <div class="card-body">
                                        <form action="{{ route('parts.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3 row">
                                                <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add Part">
                                            </div>
