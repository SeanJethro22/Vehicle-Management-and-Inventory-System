                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-lg"><i class="fa fa-car" aria-hidden="true"></i>&nbsp; Add New Vehicle</h3>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-5 mb-3 mb-sm-0">
                                                    <label for="vehicleName" class="col-form-label">Name</label>
                                                        <input type="text" class="form-control @error('vehicleName') is-invalid @enderror" id="vehicleName" name="vehicleName" value="{{ old('vehicleName') }}">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="plateNumber" class="col-form-label">Plate Number</label>
                                                        <input type="text" class="form-control @error('plateNumber') is-invalid @enderror" id="plateNumber" name="plateNumber" value="{{ old('plateNumber') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="bodyType" class="col-form-label">Body Type</label>
                                                        <input type="text" class="form-control @error('bodyType') is-invalid @enderror" id="bodyType" name="bodyType" value="{{ old('bodyType') }}">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="yearModel" class="col-form-label">Year Model</label>
                                                        <input type="number" class="form-control @error('yearModel') is-invalid @enderror" id="yearModel" name="yearModel" value="{{ old('yearModel') }}">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="engineNumber" class="col-form-label">Engine Number</label>
                                                        <input type="text" class="form-control @error('engineNumber') is-invalid @enderror" id="engineNumber" name="engineNumber" value="{{ old('engineNumber') }}">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="chassisNumber" class="col-form-label">Chassis Number</label>
                                                        <input type="text" class="form-control @error('chassisNumber') is-invalid @enderror" id="chassisNumber" name="chassisNumber" value="{{ old('chassisNumber') }}">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="purchaseDate" class="col-form-label">Purchased Date</label>
                                                        <input type="date" class="form-control @error('purchaseDate') is-invalid @enderror" id="purchaseDate" name="purchaseDate" value="{{ old('purchaseDate') }}">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="registrationDate" class="col-form-label">Registration Date</label>
                                                        <input type="date" class="form-control @error('registrationDate') is-invalid @enderror" id="registrationDate" name="registrationDate" value="{{ old('registrationDate') }}">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="purchaseCost" class="col-form-label">Purchased Cost</label>
                                                        <input type="text" class="form-control @error('purchaseCost') is-invalid @enderror" id="purchaseCost" name="purchaseCost" value="{{ old('purchaseCost') }}">
                                                ...
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="depreciationCost" class="col-form-label">Depreciation Cost</label>
                                                        <input type="text" class="form-control @error('depreciationCost') is-invalid @enderror" id="depreciationCost" name="depreciationCost" value="{{ old('depreciationCost') }}">
                                                ...
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="propertyNumber" class="col-form-label">Property Number</label>
                                                        <input type="text" class="form-control @error('propertyNumber') is-invalid @enderror" id="propertyNumber" name="propertyNumber" value="{{ old('propertyNumber') }}">
