                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    <label for="supplierName" class="col-form-label">Supplier Name</label>
                                                        <input type="text" class="form-control @error('supplierName') is-invalid @enderror" id="supplierName" name="supplierName" value="{{ $supplier->supplierName }}" required>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="contactPerson" class="col-form-label">Contact Person</label>
                                                        <input type="text" class="form-control @error('contactPerson') is-invalid @enderror" id="contactPerson" name="contactPerson" value="{{ $supplier->contactPerson }}" required>
                                                ...
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="designation" class="col-form-label">Designation</label>
                                                        <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" name="designation" value="{{ $supplier->designation }}" required>
                                                ...
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="contact" class="col-form-label">Contact Number</label>
                                                        <input type="number" class="form-control @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ $supplier->contact }}" required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="emailAddress" class="col-form-label">Email Address</label>
                                                        <input type="email" class="form-control @error('emailAddress') is-invalid @enderror" id="emailAddress" name="emailAddress" value="{{ $supplier->emailAddress }}" required>
                                                ...
                                                <div class="col-sm-2 mb-3 mb-sm-0">
                                                    <label for="yearEst" class="col-form-label">Year Established</label>
                                                        <input type="year" class="form-control @error('yearEst') is-invalid @enderror" id="yearEst" name="yearEst" value="{{ $supplier->yearEst }}" required>
                                            ...
                                            <div class="form-group row">                                             
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <label for="philgepsMembership" class="col-form-label">PhilGEPS Membership</label>
                                                        <select name="philgepsMembership" id="philgepsMembership" class="form-control @error('philgepsMembership') is-invalid @enderror" value="{{ $supplier->philgepsMembership }}" required>
