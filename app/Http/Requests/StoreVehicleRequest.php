...
class StoreVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        'plateNumber' => 'required|string|max:250|unique:vehicles,plateNumber',
        ...
        'engineNumber' => 'required|string|max:250|unique:vehicles,engineNumber',
        'chassisNumber' => 'required|string|max:250|unique:vehicles,chassisNumber',
        ...
        'propertyNumber' => 'required|string|max:250|unique:vehicles,propertyNumber'
        ];
    }
}
